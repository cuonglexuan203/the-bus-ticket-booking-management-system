...
namespace BusTicketManagementApplication.src.dbConnection
{
    ...
    public partial class BusManagementEntities : DbContext
    {
        ...
        public virtual ObjectResult<string> pro_ValidateUser(string username, string password)
        {
            var usernameParameter = username != null ?
                new ObjectParameter("username", username) :
                new ObjectParameter("username", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("pro_ValidateUser", usernameParameter, passwordParameter);
        }
    }
}
